...
if ($id_user) {
    ...
    if ($result->num_rows > 0):
        ...
        <tr>
            ...
            <td><?= $row["spare_part_riwayat"]; ?></td>
            <td>Rp <?= number_format($row["biaya_riwayat"], 0, ',', '.'); ?></td>
            <td>Selesai Servis</td>
        </tr>
        <?php
...
<?php
        ...
        $stmt->close();
            ...
            if (!$hasData):
                ?>
                <tr>
                    <td colspan="7" class="text-center">Tidak ada riwayat servis atau booking yang tersedia.</td>
                </tr>
                    <?php
                        endif;
                ...
                ?>
                    <tr>
                <td colspan="7" class="text-center">Silakan login untuk melihat riwayat servis.</td>
                    </tr>
                <?php
                }
            ?>
